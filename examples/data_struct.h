...
typedef struct DATAstr{
  ...
  /*** MC data ***/
  Int_t mc_npart;
  Float_t mc_Q2, mc_W, mc_Nu, mc_Xb, mc_vxe, mc_vye, mc_vze, mc_Pex, mc_Pey, mc_Pez, mc_event, e_mcmass, mc_Pe, mc_Ee, mc_revent, mc_y, mc_th_e, mc_e_Beta;
...
/*** init mix tree ***/
int initMixTree(TTree *t, DATAMIX* evnt = 0){

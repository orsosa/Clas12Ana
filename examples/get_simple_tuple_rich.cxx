...
//  TH1F *ht = new TH1F("ht","tdiff",1000,-15,15); 
  ...
  while (t->Next())
  {
    ...
    if(nRows>0 && (t->GetCategorization(0)) == "pi-")  
    {
      ...
      DataElec[111] = t->TrajFTOF1AZ();
      DataElec[112] = t->TrajFTOF1BX();
      DataElec[113] = t->TrajFTOF1BY();
      DataElec[114] = t->TrajFTOF1BZ();
      DataElec[115] = t->TrajFTOF2X();
      DataElec[116] = t->TrajFTOF2Y();
      DataElec[117] = t->TrajFTOF2Z();
      DataElec[118] = t->Traj101X();
      DataElec[119] = t->Traj101Y();
      DataElec[120] = t->Traj101Z();
      DataElec[121] = t->Traj102X();
      DataElec[122] = t->Traj102Y();
      DataElec[123] = t->Traj102Z();
      DataElec[124] = t->TrajFMT1X();
      DataElec[125] = t->TrajFMT1Y();
      DataElec[126] = t->TrajFMT1Z();
      DataElec[127] = t->TrajFMT2X();
      DataElec[128] = t->TrajFMT2Y();
      DataElec[129] = t->TrajFMT2Z();
      DataElec[130] = t->TrajFMT3X();
      DataElec[131] = t->TrajFMT3Y();
      DataElec[132] = t->TrajFMT3Z();
      DataElec[133] = t->TrajFMT4X();
      DataElec[134] = t->TrajFMT4Y();
      DataElec[135] = t->TrajFMT4Z();
      DataElec[136] = t->TrajFMT5X();
      DataElec[137] = t->TrajFMT5Y();
      DataElec[138] = t->TrajFMT5Z();

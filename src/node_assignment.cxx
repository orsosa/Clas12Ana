...
int TIdentificatorCLAS12::InitNodes()
{
  ...
  REC__RICH_chi2  =  fReader->getBranch<float>("REC::RICH","chi2");
  REC__RICH_detector  =  fReader->getBranch<int8_t>("REC::RICH","detector");
  REC__RICH_energy  =  fReader->getBranch<float>("REC::RICH","energy");
  REC__RICH_hx  =  fReader->getBranch<float>("REC::RICH","hx");
  REC__RICH_hy  =  fReader->getBranch<float>("REC::RICH","hy");
  REC__RICH_hz  =  fReader->getBranch<float>("REC::RICH","hz");
  REC__RICH_index  =  fReader->getBranch<int16_t>("REC::RICH","index");
  REC__RICH_layer  =  fReader->getBranch<int8_t>("REC::RICH","layer");
  REC__RICH_path  =  fReader->getBranch<float>("REC::RICH","path");
  REC__RICH_pindex  =  fReader->getBranch<int16_t>("REC::RICH","pindex");
  REC__RICH_sector  =  fReader->getBranch<int8_t>("REC::RICH","sector");
  REC__RICH_status  =  fReader->getBranch<int16_t>("REC::RICH","status");
  REC__RICH_time  =  fReader->getBranch<float>("REC::RICH","time");
  REC__RICH_x  =  fReader->getBranch<float>("REC::RICH","x");
  REC__RICH_y  =  fReader->getBranch<float>("REC::RICH","y");
  REC__RICH_z  =  fReader->getBranch<float>("REC::RICH","z");
  ...
  RICH__hadrons_EtaC_ele  =  fReader->getBranch<float>("RICH::hadrons","EtaC_ele");
  RICH__hadrons_EtaC_k  =  fReader->getBranch<float>("RICH::hadrons","EtaC_k");
  RICH__hadrons_EtaC_max  =  fReader->getBranch<float>("RICH::hadrons","EtaC_max");
  RICH__hadrons_EtaC_min  =  fReader->getBranch<float>("RICH::hadrons","EtaC_min");
  RICH__hadrons_EtaC_pi  =  fReader->getBranch<float>("RICH::hadrons","EtaC_pi");
  RICH__hadrons_EtaC_pr  =  fReader->getBranch<float>("RICH::hadrons","EtaC_pr");
  RICH__hadrons_hit_index  =  fReader->getBranch<int16_t>("RICH::hadrons","hit_index");
  RICH__hadrons_id  =  fReader->getBranch<int16_t>("RICH::hadrons","id");
  RICH__hadrons_particle_index  =  fReader->getBranch<int16_t>("RICH::hadrons","particle_index");
  RICH__hadrons_traced_emix  =  fReader->getBranch<float>("RICH::hadrons","traced_emix");
  RICH__hadrons_traced_emiy  =  fReader->getBranch<float>("RICH::hadrons","traced_emiy");
  RICH__hadrons_traced_emiz  =  fReader->getBranch<float>("RICH::hadrons","traced_emiz");
  RICH__hadrons_traced_hitx  =  fReader->getBranch<float>("RICH::hadrons","traced_hitx");
  RICH__hadrons_traced_hity  =  fReader->getBranch<float>("RICH::hadrons","traced_hity");
  RICH__hadrons_traced_hitz  =  fReader->getBranch<float>("RICH::hadrons","traced_hitz");
  RICH__hadrons_traced_path  =  fReader->getBranch<float>("RICH::hadrons","traced_path");
  RICH__hadrons_traced_phi  =  fReader->getBranch<float>("RICH::hadrons","traced_phi");
  RICH__hadrons_traced_the  =  fReader->getBranch<float>("RICH::hadrons","traced_the");
  RICH__hadrons_traced_time  =  fReader->getBranch<float>("RICH::hadrons","traced_time");
  ...
  RICH__newclusters_charge  =  fReader->getBranch<float>("RICH::newclusters","charge");
  RICH__newclusters_id  =  fReader->getBranch<int16_t>("RICH::newclusters","id");
  RICH__newclusters_pmt  =  fReader->getBranch<int16_t>("RICH::newclusters","pmt");
  RICH__newclusters_rawtime  =  fReader->getBranch<float>("RICH::newclusters","rawtime");
  RICH__newclusters_sector  =  fReader->getBranch<int16_t>("RICH::newclusters","sector");
  RICH__newclusters_size  =  fReader->getBranch<int16_t>("RICH::newclusters","size");
  RICH__newclusters_tile  =  fReader->getBranch<int16_t>("RICH::newclusters","tile");
  RICH__newclusters_time  =  fReader->getBranch<float>("RICH::newclusters","time");
  RICH__newclusters_wtime  =  fReader->getBranch<float>("RICH::newclusters","wtime");
  RICH__newclusters_wx  =  fReader->getBranch<float>("RICH::newclusters","wx");
  RICH__newclusters_wy  =  fReader->getBranch<float>("RICH::newclusters","wy");
  RICH__newclusters_wz  =  fReader->getBranch<float>("RICH::newclusters","wz");
  RICH__newclusters_x  =  fReader->getBranch<float>("RICH::newclusters","x");
  RICH__newclusters_y  =  fReader->getBranch<float>("RICH::newclusters","y");
  RICH__newclusters_z  =  fReader->getBranch<float>("RICH::newclusters","z");
  RICH__newhits_anode  =  fReader->getBranch<int16_t>("RICH::newhits","anode");
  RICH__newhits_cluster  =  fReader->getBranch<int16_t>("RICH::newhits","cluster");
  RICH__newhits_duration  =  fReader->getBranch<int16_t>("RICH::newhits","duration");
  RICH__newhits_glx  =  fReader->getBranch<int16_t>("RICH::newhits","glx");
  RICH__newhits_gly  =  fReader->getBranch<int16_t>("RICH::newhits","gly");
  RICH__newhits_id  =  fReader->getBranch<int16_t>("RICH::newhits","id");
  RICH__newhits_idx  =  fReader->getBranch<int16_t>("RICH::newhits","idx");
  RICH__newhits_idy  =  fReader->getBranch<int16_t>("RICH::newhits","idy");
  RICH__newhits_pmt  =  fReader->getBranch<int16_t>("RICH::newhits","pmt");
  RICH__newhits_rawtime  =  fReader->getBranch<float>("RICH::newhits","rawtime");
  RICH__newhits_sector  =  fReader->getBranch<int16_t>("RICH::newhits","sector");
  RICH__newhits_tile  =  fReader->getBranch<int16_t>("RICH::newhits","tile");
  RICH__newhits_time  =  fReader->getBranch<float>("RICH::newhits","time");
  RICH__newhits_x  =  fReader->getBranch<float>("RICH::newhits","x");
  RICH__newhits_xtalk  =  fReader->getBranch<int16_t>("RICH::newhits","xtalk");
  RICH__newhits_y  =  fReader->getBranch<float>("RICH::newhits","y");
  RICH__newhits_z  =  fReader->getBranch<float>("RICH::newhits","z");
  RICH__photons_analytic_EtaC  =  fReader->getBranch<float>("RICH::photons","analytic_EtaC");
  RICH__photons_analytic_aeron  =  fReader->getBranch<float>("RICH::photons","analytic_aeron");
  RICH__photons_analytic_bgpr  =  fReader->getBranch<float>("RICH::photons","analytic_bgpr");
  RICH__photons_analytic_elpr  =  fReader->getBranch<float>("RICH::photons","analytic_elpr");
  RICH__photons_analytic_kpr  =  fReader->getBranch<float>("RICH::photons","analytic_kpr");
  RICH__photons_analytic_nrfl  =  fReader->getBranch<int16_t>("RICH::photons","analytic_nrfl");
  RICH__photons_analytic_nrfr  =  fReader->getBranch<int16_t>("RICH::photons","analytic_nrfr");
  RICH__photons_analytic_path  =  fReader->getBranch<float>("RICH::photons","analytic_path");
  RICH__photons_analytic_phi  =  fReader->getBranch<float>("RICH::photons","analytic_phi");
  RICH__photons_analytic_pipr  =  fReader->getBranch<float>("RICH::photons","analytic_pipr");
  RICH__photons_analytic_prpr  =  fReader->getBranch<float>("RICH::photons","analytic_prpr");
  RICH__photons_analytic_the  =  fReader->getBranch<float>("RICH::photons","analytic_the");
  RICH__photons_analytic_time  =  fReader->getBranch<float>("RICH::photons","analytic_time");
  RICH__photons_hadron_index  =  fReader->getBranch<int16_t>("RICH::photons","hadron_index");
  RICH__photons_hit_index  =  fReader->getBranch<int16_t>("RICH::photons","hit_index");
  RICH__photons_id  =  fReader->getBranch<int16_t>("RICH::photons","id");
  RICH__photons_start_time  =  fReader->getBranch<float>("RICH::photons","start_time");
  RICH__photons_traced_EtaC  =  fReader->getBranch<float>("RICH::photons","traced_EtaC");
  RICH__photons_traced_aeron  =  fReader->getBranch<float>("RICH::photons","traced_aeron");
  RICH__photons_traced_bgpr  =  fReader->getBranch<float>("RICH::photons","traced_bgpr");
  RICH__photons_traced_elpr  =  fReader->getBranch<float>("RICH::photons","traced_elpr");
  RICH__photons_traced_hitx  =  fReader->getBranch<float>("RICH::photons","traced_hitx");
  RICH__photons_traced_hity  =  fReader->getBranch<float>("RICH::photons","traced_hity");
  RICH__photons_traced_hitz  =  fReader->getBranch<float>("RICH::photons","traced_hitz");
  RICH__photons_traced_kpr  =  fReader->getBranch<float>("RICH::photons","traced_kpr");
  RICH__photons_traced_nrfl  =  fReader->getBranch<int16_t>("RICH::photons","traced_nrfl");
  RICH__photons_traced_nrfr  =  fReader->getBranch<int16_t>("RICH::photons","traced_nrfr");
  RICH__photons_traced_path  =  fReader->getBranch<float>("RICH::photons","traced_path");
  RICH__photons_traced_phi  =  fReader->getBranch<float>("RICH::photons","traced_phi");
  RICH__photons_traced_pipr  =  fReader->getBranch<float>("RICH::photons","traced_pipr");
  RICH__photons_traced_prpr  =  fReader->getBranch<float>("RICH::photons","traced_prpr");
  RICH__photons_traced_the  =  fReader->getBranch<float>("RICH::photons","traced_the");
  RICH__photons_traced_time  =  fReader->getBranch<float>("RICH::photons","traced_time");
  RICH__photons_type  =  fReader->getBranch<int16_t>("RICH::photons","type");

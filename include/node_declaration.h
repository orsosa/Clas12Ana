//// File automatically produced by format_hiponodes.py do not make changes here!!
   ...
   hipo::node<float>         *REC__RICH_chi2 ;
   hipo::node<int8_t>    *REC__RICH_detector ;
   hipo::node<float>       *REC__RICH_energy ;
   hipo::node<float>           *REC__RICH_hx ;
   hipo::node<float>           *REC__RICH_hy ;
   hipo::node<float>           *REC__RICH_hz ;
   hipo::node<int16_t>      *REC__RICH_index ;
   hipo::node<int8_t>       *REC__RICH_layer ;
   hipo::node<float>         *REC__RICH_path ;
   hipo::node<int16_t>     *REC__RICH_pindex ;
   hipo::node<int8_t>      *REC__RICH_sector ;
   hipo::node<int16_t>     *REC__RICH_status ;
   hipo::node<float>         *REC__RICH_time ;
   hipo::node<float>            *REC__RICH_x ;
   hipo::node<float>            *REC__RICH_y ;
   hipo::node<float>            *REC__RICH_z ;
   ...
   hipo::node<float>           *RICH__hadrons_EtaC_ele ;
   hipo::node<float>             *RICH__hadrons_EtaC_k ;
   hipo::node<float>           *RICH__hadrons_EtaC_max ;
   hipo::node<float>           *RICH__hadrons_EtaC_min ;
   hipo::node<float>            *RICH__hadrons_EtaC_pi ;
   hipo::node<float>            *RICH__hadrons_EtaC_pr ;
   hipo::node<int16_t>        *RICH__hadrons_hit_index ;
   hipo::node<int16_t>               *RICH__hadrons_id ;
   hipo::node<int16_t>   *RICH__hadrons_particle_index ;
   hipo::node<float>        *RICH__hadrons_traced_emix ;
   hipo::node<float>        *RICH__hadrons_traced_emiy ;
   hipo::node<float>        *RICH__hadrons_traced_emiz ;
   hipo::node<float>        *RICH__hadrons_traced_hitx ;
   hipo::node<float>        *RICH__hadrons_traced_hity ;
   hipo::node<float>        *RICH__hadrons_traced_hitz ;
   hipo::node<float>        *RICH__hadrons_traced_path ;
   hipo::node<float>         *RICH__hadrons_traced_phi ;
   hipo::node<float>         *RICH__hadrons_traced_the ;
   hipo::node<float>        *RICH__hadrons_traced_time ;
   ...
   hipo::node<float>      *RICH__newclusters_charge ;
   hipo::node<int16_t>        *RICH__newclusters_id ;
   hipo::node<int16_t>       *RICH__newclusters_pmt ;
   hipo::node<float>     *RICH__newclusters_rawtime ;
   hipo::node<int16_t>    *RICH__newclusters_sector ;
   hipo::node<int16_t>      *RICH__newclusters_size ;
   hipo::node<int16_t>      *RICH__newclusters_tile ;
   hipo::node<float>        *RICH__newclusters_time ;
   hipo::node<float>       *RICH__newclusters_wtime ;
   hipo::node<float>          *RICH__newclusters_wx ;
   hipo::node<float>          *RICH__newclusters_wy ;
   hipo::node<float>          *RICH__newclusters_wz ;
   hipo::node<float>           *RICH__newclusters_x ;
   hipo::node<float>           *RICH__newclusters_y ;
   hipo::node<float>           *RICH__newclusters_z ;
   hipo::node<int16_t>      *RICH__newhits_anode ;
   hipo::node<int16_t>    *RICH__newhits_cluster ;
   hipo::node<int16_t>   *RICH__newhits_duration ;
   hipo::node<int16_t>        *RICH__newhits_glx ;
   hipo::node<int16_t>        *RICH__newhits_gly ;
   hipo::node<int16_t>         *RICH__newhits_id ;
   hipo::node<int16_t>        *RICH__newhits_idx ;
   hipo::node<int16_t>        *RICH__newhits_idy ;
   hipo::node<int16_t>        *RICH__newhits_pmt ;
   hipo::node<float>      *RICH__newhits_rawtime ;
   hipo::node<int16_t>     *RICH__newhits_sector ;
   hipo::node<int16_t>       *RICH__newhits_tile ;
   hipo::node<float>         *RICH__newhits_time ;
   hipo::node<float>            *RICH__newhits_x ;
   hipo::node<int16_t>      *RICH__newhits_xtalk ;
   hipo::node<float>            *RICH__newhits_y ;
   hipo::node<float>            *RICH__newhits_z ;
   hipo::node<float>      *RICH__photons_analytic_EtaC ;
   hipo::node<float>     *RICH__photons_analytic_aeron ;
   hipo::node<float>      *RICH__photons_analytic_bgpr ;
   hipo::node<float>      *RICH__photons_analytic_elpr ;
   hipo::node<float>       *RICH__photons_analytic_kpr ;
   hipo::node<int16_t>    *RICH__photons_analytic_nrfl ;
   hipo::node<int16_t>    *RICH__photons_analytic_nrfr ;
   hipo::node<float>      *RICH__photons_analytic_path ;
   hipo::node<float>       *RICH__photons_analytic_phi ;
   hipo::node<float>      *RICH__photons_analytic_pipr ;
   hipo::node<float>      *RICH__photons_analytic_prpr ;
   hipo::node<float>       *RICH__photons_analytic_the ;
   hipo::node<float>      *RICH__photons_analytic_time ;
   hipo::node<int16_t>     *RICH__photons_hadron_index ;
   hipo::node<int16_t>        *RICH__photons_hit_index ;
   hipo::node<int16_t>               *RICH__photons_id ;
   hipo::node<float>         *RICH__photons_start_time ;
   hipo::node<float>        *RICH__photons_traced_EtaC ;
   hipo::node<float>       *RICH__photons_traced_aeron ;
   hipo::node<float>        *RICH__photons_traced_bgpr ;
   hipo::node<float>        *RICH__photons_traced_elpr ;
   hipo::node<float>        *RICH__photons_traced_hitx ;
   hipo::node<float>        *RICH__photons_traced_hity ;
   hipo::node<float>        *RICH__photons_traced_hitz ;
   hipo::node<float>         *RICH__photons_traced_kpr ;
   hipo::node<int16_t>      *RICH__photons_traced_nrfl ;
   hipo::node<int16_t>      *RICH__photons_traced_nrfr ;
   hipo::node<float>        *RICH__photons_traced_path ;
   hipo::node<float>         *RICH__photons_traced_phi ;
   hipo::node<float>        *RICH__photons_traced_pipr ;
   hipo::node<float>        *RICH__photons_traced_prpr ;
   hipo::node<float>         *RICH__photons_traced_the ;
   hipo::node<float>        *RICH__photons_traced_time ;
   hipo::node<int16_t>             *RICH__photons_type ;
